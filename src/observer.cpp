...
int main(int argc, char **argv)
{
    ...
    else
    {
        ...
        ros::Subscriber quadrotor_feedback_sub = nh.subscribe<test_controller::UAVState>(feedback_topic, 10, std::bind(simuFeedbackCallback, std::placeholders::_1, std::ref(quadrotor_obs.measurement)));
