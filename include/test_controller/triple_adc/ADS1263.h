...
// 以下类型 UBYTE 和 UDOUBLE 请确保在 dev_config.h 中已定义
...
public:
    ...
    UBYTE readData(UBYTE Reg);
    UBYTE checkSum(UDOUBLE val, UBYTE byt);
    void waitDRDY(void);
    UBYTE readChipID(void);
    void setMode(UBYTE Mode);
    void configADC1(ADS1263_GAIN gain, ADS1263_DRATE drate, ADS1263_DELAY delay);
    void configADC2(ADS1263_ADC2_GAIN gain, ADS1263_ADC2_DRATE drate, ADS1263_DELAY delay);
    UBYTE initADC1(ADS1263_DRATE rate);
    UBYTE initADC2(ADS1263_ADC2_DRATE rate);
    ...
    void getAll(UBYTE *List, UDOUBLE *Value, int Number);
    void getAll_ADC2(UDOUBLE *ADC_Value);
    void softReset(void);
    void softStop(void);
    void softStart(void);
    void calibrate(void);
    void setGainRate(void);
    void setDelay(void);
    void setFilter(void);
