...
#include "test_controller/observer/observer.h"  // 此头文件中定义了基类 Observer，其 update() 返回类型为 Eigen::VectorXd
...
public:
  ...
  // 存储 Observer* 的向量，要求所有 Observer 对象均继承自 Observer 且 update() 返回 Eigen::VectorXd
